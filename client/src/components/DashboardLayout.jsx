      ...
      <aside className={`fixed top-0 left-0 h-full w-[240px] bg-white border-r border-slate-200/80 z-50 flex flex-col transition-transform duration-300 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="px-3 pb-4">
          <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-4 border border-primary-100/50">
            ...
            <p className="text-[13px] font-semibold text-slate-800 mb-1">Need help?</p>
            <p className="text-[11.5px] text-slate-500 mb-3 leading-relaxed">Check our guides and FAQs</p>
            <button className="w-full py-2 bg-white text-primary-600 rounded-lg text-xs font-semibold border border-primary-100 hover:bg-primary-50 transition-colors">
              Support Center
            </button>
          </div>
        </div>
